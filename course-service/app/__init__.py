# course-service/app/__init__.py
# This file initializes the Flask application and its extensions for the Course Service.
...
def create_app():
    ...
    if app.config.get('APPLICATIONINSIGHTS_CONNECTION_STRING'):
        resource = Resource.create({
            SERVICE_NAME: "course-service"  # Service name for Application Insights
        })
    ...
    from app.commands import consume_course_events_command
    app.cli.add_command(consume_course_events_command)
