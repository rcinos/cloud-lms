# course-service/wsgi.py
# This is the main entry point for the Course Service Flask application.
...
if __name__ == '__main__':
    ...
    # The port is fetched from environment variables, defaulting to 5001.
