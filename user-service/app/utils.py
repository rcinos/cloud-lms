...
def admin_required(f):
    """
    Decorator to ensure that the authenticated user has 'instructor' (admin) privileges.
    ...
    def decorated(*args, **kwargs):
        ...
        try:
            ...
            if data.get('user_type') != 'instructor':
                ...
                return jsonify({'error': 'Admin privileges required', 'code': 'FORBIDDEN_ACCESS'}), 403
        ...
        # If token is valid and user is an instructor, call the original function.
