# progress-service/config.py
# This file defines the configuration settings for the Progress Service.
...
class Config:
    ...
    SECRET_KEY = os.environ.get('SECRET_KEY', 'dev-progress-secret-key-flask')
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL_PROGRESS',
                                             'postgresql://user:password@localhost:5435/progress_db')
    ...
    CACHE_REDIS_URL = os.environ.get('REDIS_URL', 'redis://localhost:6379/2')  # Using database 2 for Progress Service
